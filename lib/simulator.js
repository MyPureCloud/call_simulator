module.exports = function(sipEngine, initialIpAddress){
    ...
    function startSimulation(configuration){
        if(typeof configuration === "undefined" ||
            configuration === null ||
            typeof configuration.edgeServer === "undefined" ||
            configuration.edgeServer === null ||
            typeof configuration.edgeServer.ip === "undefined" ||
             configuration.edgeServer.ip === ''){
                console.log("can't start server; not configured.");
                return;
        }
